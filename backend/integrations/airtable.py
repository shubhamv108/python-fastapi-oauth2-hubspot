...
authorization_url = f'https://app.hubspot.com/oauth/authorize?client_id={CLIENT_ID}&scope=contacts%20automation&redirect_uri=http:%3A%2Flocalhost:8000%2Fintegrations%2Fairtable%2Foauth2callback'
